...
from .efficient_transformer_decoder_layer import EfficientTransformerDecoderLayer


@register_decoder
class EfficientTransformerDecoder(AbstractDecoder):
    """
    ...
    def build(self,
        ...
        if self._share_layers:
            self._layer = EfficientTransformerDecoderLayer(
                                                  self_attention_type=self._self_attention_type,
                                                  cross_attention_type=self._cross_attention_type,
            ...
            self._layers = nn.ModuleList([EfficientTransformerDecoderLayer(
                                                                  self_attention_type=self._self_attention_type,
                                                                  cross_attention_type=self._cross_attention_type,
                                                                  d_model=self._d_model,
                                                                  nhead=self._n_head,
